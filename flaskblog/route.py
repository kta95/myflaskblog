...
from flaskblog.form import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='KyawThetAung@ktablog.com', recipients=[user.email])
